  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
      ...
      <form className="grid gap-4 mb-6" onSubmit={handleAddProduct}>
        ...
        <input name="length" placeholder="Length" type="number" className="border p-2 rounded" />
        <input name="stock" placeholder="Stock" type="number" className="border p-2 rounded" />
