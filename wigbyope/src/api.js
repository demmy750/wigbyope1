...
//     return fetch(`${API_BASE_URL}${normalizeEndpoint("/upload/product")}`, {
//       method: "POST",
//       headers: {
//         ...(token ? { Authorization: `Bearer ${token}` } : {}),
//       },
...
//     return fetch(`${API_BASE_URL}${normalizeEndpoint("/upload/blog")}`, {
//       method: "POST",
//       headers: {
//         ...(token ? { Authorization: `Bearer ${token}` } : {}),
//       },
...
// ------------------------
// Orders API (NEW - Added for consistency)
// ------------------------
export const ordersAPI = {
  getAll: () => fetchWithAuth("/orders/all"),  // For admin: Fetch all orders
